...
export default {
  ...
  setup() {
    ...
    const allTags = ['a', 'apple', 'abandan', 'b', 'box', 'c', 'cat', 'dahdshfkl', 'sfhdklasfjkdlj', 'ofhwasif', 'Lorem', 'ipsum', 'dolor', 'sit,', 'amet', 'consectetur', 'adipisicing', 'elit.', 'Ipsa', 'tempora', 'iusto', 'nobis', 'reiciendis', 'explicabo', 'ea', 'exercitationem', 'quibusdam', 'totam', 'libero?', 'Quaerat', 'ab', 'officia', 'sequi', 'fuga', 'non', 'rerum', 'in', 'cumque', 'ducimus', 'voluptate'];

    // group
    const groups = ref(['a', 'apple', 'abandan', 'b', 'box']);
    const allGroups = ['a', 'apple', 'abandan', 'b', 'box', 'c', 'cat', 'dahdshfkl', 'sfhdklasfjkdlj', 'ofhwasif', 'Lorem', 'ipsum', 'dolor', 'sit,', 'amet', 'consectetur', 'adipisicing', 'elit.', 'Ipsa', 'tempora', 'iusto', 'nobis', 'reiciendis', 'explicabo', 'ea', 'exercitationem', 'quibusdam', 'totam', 'libero?', 'Quaerat', 'ab', 'officia', 'sequi', 'fuga', 'non', 'rerum', 'in', 'cumque', 'ducimus', 'voluptate'];
