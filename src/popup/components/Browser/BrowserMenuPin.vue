<template>
  <div class="w-full flex justify-between items-start">
    ...
    <button
      title="hide pin list"
      class="flex justify-center items-center px-1 py-0.5 text-white bg-blue-400 hover:bg-blue-600 border-2 border-blue-400 hover:border-blue-600 rounded space-x-0.5"
